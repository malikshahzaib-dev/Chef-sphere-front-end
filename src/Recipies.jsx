      ...
      <div className="" style={{ background: "#fff5ef", overflow: "hidden", padding: "35px" }}>
        <div className="mt-2" style={{ padding: "80px" }}>
          <div style={{ marginBottom: "0px" }}>
            <h1 style={{ textAlign: "center", fontWeight: "700" }}>All Recipies</h1>
          ...
          {/* <div className="d-flex justify-content-center align-items-center  mt-5">
            <button  onClick={() => navigate("/MyRecipes")} style={{height:"40px",width:"120px"}} className="rounded border">My Recipes</button>
          </div> */}
        </div>
          ...
          <div className="row">
            {
              recepies.map((recepie,index) => (
                  ...
                  <div  className="col-4 gy-4  rounded border-none p-2 ml-2" style={{ height: "400px",background: "white", borderRadius: "8px" }}>
                    <img key={index}    src={recepie.image || "https://images.pexels.com/photos/1640774/pexels-photo-1640774.jpeg"}  className="rounded" alt="" style={{ height: "200px", width: "100%" }} />
                      ...
                      <p style={{ paddingLeft: "40px" }}>
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="yellow" className="icon icon-tabler icons-tabler-filled icon-tabler-star"><path stroke="none" d="M0 0h24v24H0z" fill="none" /><path d="M8.243 7.34l-6.38 .925l-.113 .023a1 1 0 0 0 -.44 1.684l4.622 4.499l-1.09 6.355l-.013 .11a1 1 0 0 0 1.464 .944l5.706 -3l5.693 3l.1 .046a1 1 0 0 0 1.352 -1.1l-1.091 -6.355l4.624 -4.5l.078 -.085a1 1 0 0 0 -.633 -1.62l-6.38 -.926l-2.852 -5.78a1 1 0 0 0 -1.794 0l-2.853 5.78z" /></svg> 
                         4.8(134)   </p>
                            ...
                            <p>
                           <svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  className="icon icon-tabler icons-tabler-outline icon-tabler-clock-hour-3"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M12 12m-9 0a9 9 0 1 0 18 0a9 9 0 1 0 -18 0" /><path d="M12 12h3.5" /><path d="M12 7v5" /></svg>  35min  
                           </p>
                              <p>
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icons-tabler-outline icon-tabler-user-search"><path stroke="none" d="M0 0h24v24H0z" fill="none" /><path d="M8 7a4 4 0 1 0 8 0a4 4 0 0 0 -8 0" /><path d="M6 21v-2a4 4 0 0 1 4 -4h1.5" /><path d="M18 18m-3 0a3 3 0 1 0 6 0a3 3 0 1 0 -6 0" /><path d="M20.2 20.2l1.8 1.8" /></svg> 4</p>
                    </div>
