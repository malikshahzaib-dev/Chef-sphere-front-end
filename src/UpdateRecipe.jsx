...
const UpdateRecipe = () => {
    ...
    useEffect(() => {
        fetch(`http://localhost:3000/recipes/${id}`, {
            ...
            setTitle(data.title),
                ...
                setPersonServing(data.personServing),
  ...
  const payload = {
    ...
    ingredients,
    instructions,
    // image: "https://example.com/image.jpg" or image URL if needed
  };
            ...
            <form onSubmit={handleSubmit}>
                <div className=" rounded mt-2" style={{ background: "#fff5ef", padding: "80PX" }}>
                    <div style={{ paddingLeft: "70px", paddingRight: "70px", marginBottom: "30px" }}>
                        <h1 style={{ fontWeight: "semibold" }}>update  Recipe</h1>
                    ...
                    <div className="mb-4" style={{ height: "875px", width: "100%", paddingLeft: "70px", paddingRight: "70px" }}>
                        <div className="rounded border" style={{ padding: "20px", background: "#fff5ef" }}>
                            ...
                            <div>
                                ...
                                <input value={title} onChange={(e) => { setTitle(e.target.value) }} className="rounded" type="text" name="title" id="title" placeholder="enter-recipie-title" style={{ height: "40px", width: "100%", border: "1px solid #ced4da", paddingLeft: "12px" }} />
                            </div>


                            <div>
                                <label className="mt-3" htmlFor="cook-time">cook time </label><br />
                                <input value={cookTime} onChange={(e) => { setCookTime(e.target.value) }} className="rounded" type="text" name="cook-time" id="cook-time" placeholder="enter-recipie-title" style={{ height: "40px", width: "100%", border: "1px solid #ced4da", paddingLeft: "12px" }} />
                            </div>

                            <div>
                                <label className="mt-3" htmlFor="person">person serving </label><br />
                                <input value={personServing} onChange={(e) => { setPersonServing(e.target.value) }} className="rounded" type="number" name="person" id="person" placeholder="enter-recipie-title" style={{ height: "40px", width: "100%", border: "1px solid #ced4da", paddingLeft: "12px" }} />
                            </div>
                            ...
                            <div>
                                ...
                                <textarea value={description} onChange={(e) => { setDecription(e.target.value) }} className="rounded" name="description" id="description" placeholder="enter description" style={{ width: "100%", border: "1px solid #ced4da", paddingLeft: "12px" }}></textarea>
                            </div>
                            <div>
                                <label className="mt-3" htmlFor="category">Category</label><br />
                                <select value={category} onChange={(e) => { SetCategory(e.target.value) }} className="rounded" name="category" id="category" style={{ width: "100%", height: "40px", paddingLeft: "12px", border: "1px solid #ced4da" }}>
                    ...
                    <div className=" d-flex justify-content-center mt-3">
                        <div className="border rounded " style={{ padding: 30, background: "white", height: "400px", width: "89%" }}>
